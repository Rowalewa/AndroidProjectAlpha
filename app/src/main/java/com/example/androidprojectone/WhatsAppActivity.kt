...
fun WhatsApp(){
    ...
    TopAppBar(title = { Text(text = "WhatsApp",
        ...
        actions = {
            IconButton(onClick = { Toast.makeText(context, "You have clicked a Call bar", Toast.LENGTH_SHORT).show() }) {
            ...
            IconButton(onClick = { Toast.makeText(context, "You have clicked a Menu", Toast.LENGTH_SHORT).show() }) {
                Icon(imageVector = Icons.Filled.Search, contentDescription = "Share", tint = Color.White)
